...
class Products {
  handleSetLocationStorage(element, id) {
    ...
    counter.renderCounter(products.length);
  }
    ...
    headphones.forEach(({ id, img, title, rate, price }) => {
      ...
      <div class="headphones-card">
            ...
            <div class="card-content">
              ...
              <button class="card-content-button" type="button" onclick="product.handleSetLocationStorage(this, '${id}')">
              Купить
              </button>
            </div>
            <!-- /.card-content -->
    ...
    wirelessHeadphones.forEach(({ id, img, title, rate, price }) => {
      ...
      <div class="headphones-card">
            ...
            <div class="card-content">
              ...
              <p class="card-content-price">${price} ₽</p>
              <p class="card-content-price-original">3527 ₽</p>
              <button class="card-content-button" type="button" onclick="product.handleSetLocationStorage(this, '${id}')">Купить</button>
            </div>
            <!-- /.card-content -->
          </div>
          `;
